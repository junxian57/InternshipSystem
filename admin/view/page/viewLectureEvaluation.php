                    ...
                    <div class="form-grids row widget-shadow" data-example-id="basic-forms">
                        <div class="form-body">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="" class="form-control" placeholder="REI" value="" readonly="readonly">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-12"> <label>Section C</label><br><span>Comments (if any)</span><textarea rows="6" readonly class="form-control" id="Instructions" name="Instructions" placeholder="" readonly></textarea></div>
                            <div class="row">
