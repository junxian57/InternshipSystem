...
<body class="cbp-spmenu-push">
            ...
            <div class="container">
             ...
             <div class="subtitle">
              ...
              <div class="button-group">
                <button type="submit" id="approveBtn" class="approveBtn" name="approveBtn"><i class="fa fa-check" aria-hidden="true"></i>  Accept</button>
                <button type="submit" id="rejectBtn" class="rejectBtn" name="rejectBtn"><i class="fa fa-times" aria-hidden="true"></i>  Reject</button>
              </div>
            </div>
          </form>
        </div>
  ...
  <?php
    if(isset($_POST['approveBtn'])){    
      $sql = "UPDATE Company SET cmpAccountStatus='Approved' WHERE companyID='$cmpID'";
      if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Approved!')</script>";    
        echo "<script>window.open('xt-companiesSelection.php','_self')</script>";
      } else {
