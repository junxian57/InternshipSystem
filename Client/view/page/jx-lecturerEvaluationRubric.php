...
class PDF extends TCPDF
{
    public function rubricCriteriaTable()
    {
        ...
        where ra.internshipBatchID = '$internshipBatchID'  AND ra.RoleForMark='Supervisor' AND ra.facultyID='$facultyID' group by rc.criterionID ORDER BY rcc.CriteriaSession ASC;";
    ...
    public function Header()
    {
        ...
        where ra.internshipBatchID = '$internshipBatchID'  AND ra.RoleForMark='Supervisor' AND ra.facultyID='$facultyID' ";
        $results = $db_handle1->runQuery($query);
        ...
        $this->Ln(15);
        $this->Cell(230, 5, $results[0]['Title'], 0, 1, 'L');
    }
