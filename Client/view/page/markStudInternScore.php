...
if (isset($_POST['SubmitButton']) && $_POST['SubmitButton'] == 'Add rubric assessment') {
    ...
    if (count($_POST['score']) == count($_POST['score'])) {
        if ($aMarkingScheme) {
            ...
            $newOfStudResultDto = new studResultDTO($studResultid, $studid, $finalScore, $_POST['comment'], "", "", $_POST['signature'], $markByID, $date);
...
<body class="cbp-spmenu-push">
                        ...
                        <div class="form-body">
                            <form method="post">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="" class="form-control" placeholder="REI" value="<?php echo $studProgrammeName ?>" readonly="readonly">
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-12 checkbox-group">
                                    <label id="session-B"></label>
                                    <div class="form-group table-responsive">
                                        <!-- need redesign -->
                                        <table>
                                            <thead id="session-B-thead">

                                            </thead>
                                            <tbody class="tab3-small-table" id="session-B-tbody">
                                ...
                                <div class="form-group col-md-12"> <label>Section C</label><br><span>Comments (if any)</span><textarea rows="6" class="form-control" id="comment" name="comment" placeholder=""><?php echo $results2[0]['feedback'] ?></textarea></div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <input type="text" name="signature" class="form-control" value="<?php echo $results2[0]['signature'] ?>">
                                    </div>

                                </div>
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label class="">Date: (YYYY/MM/DD)</label>
                                    </div>
                                    <div class="form-group col-md-3">
    ...
    <script>
        ...
        async function InsertSelectedRubricCriteriaTable() {
            ...
            const thead = document.getElementById("session-A-thead");
            ...
            document.getElementById('session').innerHTML = criteriaResult[0].CriteriaSession;
            ...
            if (criteriaResult !== "No Data Found") {
                console.log(currentRowMaxScore);
                ...
                for (let i = 0; i < criteriaResult.length; i++) {
                    ...
                    <td><input type="text" class="text-center" name="score[]" value="${Number(s_to_json[i].score)}" onchange="changeHandler(this,${currentRowMaxScore});" required></input>
                    </td>
                    
				    </button>
                `;
                    if (criteriaResult[i].CriteriaSession == "Section A. Progress Reports") {
                        table.appendChild(trHead);
                        table.appendChild(trLeft);
                    } else if (criteriaResult[i].CriteriaSession == "Section B. Final Reports") {
                        document.getElementById('session-B').innerHTML = criteriaResult[i].CriteriaSession;
                        tableB.appendChild(trHead);
                        tableB.appendChild(trLeft);
                    }
                    ...
                    if (s_to_json == "No Data Found") {
                        ...
                        $('#session-B-tbody').find('input[type=text]').each(function() {
                            $(this).val("");
                        });
                        score = 0;
                    }
