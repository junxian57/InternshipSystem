		...
		<div id="page-wrapper">
            ...
            <div class="input-group">
						...
						<table id="finalTable">
							...
							<?php
								$i=0;
                $get_final = "SELECT * FROM finalReport WHERE reportStatus = 'Submitted'";
              ...
              ?>
							<tr>
								...
								<td><?php echo $status; ?></td>
								<td><?php echo $submitDateTime; ?></td>
								<td><?php echo '<a href="/InternshipSystem/Client/view/page/finalRpt/'.$finalRptID.'_'.$studName.'.pdf" target="_blank">';?>View & Print</a></td>
							</tr>
							<?php } ?>
							</tbody>
						</table>
